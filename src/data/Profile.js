export default {
  ...
  education: {
    ...
    university_school: 'Dungsam Academy',
    year: '2014'
  },
  certifications: [
    { title: 'SAP Certified Application Associate - SAP Ariba Contracts 2023', issuer: 'SAP', year: '2024' },
    { title: 'MLOps in Practice: Developing, Deploying and Managing ML Models in Cloud', issuer: 'GovTech and Omdena', year: '2023' },
    { title: 'Mastering Odoo Development - Technical Fundamentals', issuer: 'Udemy', year: '2022' },
    { title: 'Essential Data Science Building Blocks Course', issuer: 'DHI and Omdena', year: '2022' },
    { title: 'Intermediate Python', issuer: 'DataCamp', year: '2022' },
