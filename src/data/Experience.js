export default [
  {
    ...
    achievements: [
      ...
      "Integrated RMA payment gateway to support secure in-app transactions across the platform.",
      "Drove scalability and performance improvements across backend services to handle concurrent load and real-time operations.",
  ...
  },
  {
    ...
    achievements: [
      ...
      "Built a responsive web application with Nuxt.js and Django REST Framework for evaluation records, reports, and real-time dashboards.",
  ...
  },
  {
    ...
    achievements: [
      ...
      "Worked the ECPF module, designing their data models, API endpoints, and frontend interfaces from architecture to delivery.",
